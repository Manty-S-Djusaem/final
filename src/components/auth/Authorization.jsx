        ...
        <div className={module.container_auth}>
            ...
            <form onSubmit={signIn}>
                ...
                <div className={module.forget}>
                    ...
                    <p> <Link to='/shop-template/recoverypasswoed'>Забыли пароль?</Link></p>
                </div>
                <div>
                ...
                <div className={module.signin}><p> Нет аккаунта? <Link to='/shop-template/registratione'></Link> </p> </div>
            </form>
        </div>
    )
